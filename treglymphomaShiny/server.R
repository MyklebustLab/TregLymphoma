...
#sc1conf = delMeta(sc1conf, c("SCT.weight", "HTO_classification.global", "HTO_margin","HTO_secondID","SCT.weight"))

sc1conf = ShinyCell::modColours(sc1conf, meta.to.mod = "Celltypes", new.colours= c('#D37295','#37A484', '#8175AA', '#F28E2B', '#B60A1C', '#8CC2CA', '#52307C', '#C3CE3D', '#8A494D', '#305691',  '#59A14F','#FFD700', '#A3ACB9'))
sc1conf = ShinyCell::modColours(sc1conf, meta.to.mod = "HTO_maxID", new.colours= c("#5698c4ff", "#ff9955ff", "#999999fe"))
sc1conf = ShinyCell::modColours(sc1conf, meta.to.mod = "HTO_classification", new.colours= c("#5698c4ff", "#ff9955ff", "#999999fe"))
...
# Plot theme 
sctheme <- function(base_size = 18, XYval = TRUE, Xang = 0, XjusH = 0.5){ 
  oupTheme = theme( 
